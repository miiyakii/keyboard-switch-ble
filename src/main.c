/*
 * src/main.c — KVM Dongle firmware (keyboard-only)
 *
...
LOG_MODULE_REGISTER(kvm_dongle, LOG_LEVEL_INF);
...
/* ═══════════════════════════════════════════════════════════════════════
 * HID Report Descriptor — keyboard only (Report ID 1)
 * ═══════════════════════════════════════════════════════════════════════ */
...
BT_HIDS_DEF(hids_obj, sizeof(payload_kb_t), 1);
